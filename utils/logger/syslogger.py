...
import logging
import sys
from .logger_settings import PROJECT_INFO_LOG, PROJECT_ERROR_LOG, PROJECT_EXCEPTION_LOG
...
class SysLogger(object):
    ...
    # init logger class
    EXCEPTION_LOGGER = logging.getLogger(PROJECT_INFO_LOG)
    ERROR_LOGGER = logging.getLogger(PROJECT_ERROR_LOG)
    INFO_LOGGER = logging.getLogger(PROJECT_EXCEPTION_LOG)
